...
import { HomeOutlined, UserOutlined, TagsOutlined, AppstoreOutlined, InfoCircleOutlined, UserAddOutlined } from '@ant-design/icons';
...
export const appRouters: any = [
  ...
  },
  {
    ...
    showInMenu: true,
    component: LoadableComponent(() => import('../../scenes/Patients')),
  },
  {
    path: '/logout',
    permission: '',
